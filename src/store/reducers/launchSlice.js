...
export const getAllLaunchData = createAsyncThunk(
  "launch/getData/All",
...
export const getUpcomingLaunchData = createAsyncThunk(
  "launch/getData/Upcoming",
  async (arg, { rejectWithValue }) => {
    try {
...
export const getSucccessfullLaunchData = createAsyncThunk(
  "launch/getData/Successful",
  async (arg, { rejectWithValue }) => {
    try {
      const { data } = await axios.get(
        "http://localhost:8001/launch/successfull"
      );
      return data;
    } catch (error) {
      rejectWithValue(error.response.data);
...
export const getFailedLaunchData = createAsyncThunk(
  "launch/getData/Failed",
  async (arg, { rejectWithValue }) => {
    try {
