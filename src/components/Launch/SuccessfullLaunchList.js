...
const SuccessfullLaunchList = () => {
  ...
  const successfullLaunchData = useSelector(
    (state) => state.successfullLaunches.successfullLaunches
  );
  ...
  const currentData = successfullLaunchData.slice(
    indexOfFirstData,
    indexOfLastData - 1
  );
    ...
    <Fragment>
      <section className={classes.list}>
        ...
        <Pagination
          ...
          totalData={successfullLaunchData.length}
          paginate={paginate}
        />
      </section>
    </Fragment>
